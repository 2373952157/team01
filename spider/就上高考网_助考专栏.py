...
def saveSql(data,subject,password):
    ...
    cursor = db.cursor()
    sql = "INSERT INTO gaokaozhukao(title,time,content,subject) VALUES (%s,%s,%s,%s)"
    try:
...
def main():
    dict = {'高考经验': 'gaokaojingyan', '答题技巧': 'datijiqiao', '情感生活': 'qingganshenghuo', '高考复读': 'gaokaofudu', '高考家长': 'gaokaojiachang', '高考励志': 'gaokaolizhi',
            '心理辅导': 'xinlifudao', '高考饮食': 'gaokaoyinshi'}
